...
# Author: Christoph Hesse (May 2020)
...
class par:
	...
	slur_str = 0.75# slur strength = the amount by which the disagreement point of the agent insulted is reduced
...
def create_pop(par):
	...
	for x in range(0,int(par.N1)):# blue agents
		...
		agents.append([a,[par.L,par.M,par.H][random.randint(0,2)],[par.L,par.M,par.H][random.randint(0,2)],[[par.L,par.M,par.H][random.randint(0,2)]],[[par.L,par.M,par.H][random.randint(0,2)]],1,moves,[[par.L,par.M,par.H][random.randint(0,2)]],[[par.L,par.M,par.H][random.randint(0,2)]],r,pop,moves])
	for z in range(0,int(par.N3)):# powerful individuals
		...
		pop = pop3s[z]
		moves = matrix(par.L,par.M,par.H,d1,d2)
		agents.append([a,[random.randint(0,2)],[random.randint(0,2)],[[par.L,par.M,par.H][random.randint(0,2)]],[[par.L,par.M,par.H][random.randint(0,2)]],3,moves,[[par.L,par.M,par.H][random.randint(0,2)]],[[par.L,par.M,par.H][random.randint(0,2)]],r,pop,moves])
	for y in range(0,int(par.N2)):# red agents
		...
		pop = pop2s[y]
		moves = matrix(par.L,par.M,par.H,d1,d2)
		agents.append([a,[random.randint(0,2)],[random.randint(0,2)],[[par.L,par.M,par.H][random.randint(0,2)]],[[par.L,par.M,par.H][random.randint(0,2)]],2,moves,[[par.L,par.M,par.H][random.randint(0,2)]],[[par.L,par.M,par.H][random.randint(0,2)]],r,pop,moves])
	return(agents)
...
def interact(par,agents):
	...
	if par.slurring == 'before':
		if agent_i[0] == 1 and agent_j[0] == 2 and random.uniform(0,1) < agent_i[9]:
			agent_j = belief_update(agent_j,-par.slur_str)
			slur_print = ' slur'
		elif agent_i[0] == 2 and agent_j[0] == 1 and random.uniform(0,1) < agent_j[9]:
			agent_i = belief_update(agent_i,-par.slur_str)
			slur_print = ' slur'
